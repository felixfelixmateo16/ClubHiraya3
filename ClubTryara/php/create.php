...
<body>
  ...
  <aside class="sidebar" role="complementary" aria-label="Sidebar">
      ...
      <nav class="sidebar-menu" role="navigation" aria-label="Main menu">
          ...
          <a href="tables.php" class="sidebar-btn"><span class="sidebar-icon"><img src="../images/table.png" alt="Tables"></span><span>Tables</span></a>
          ...
          <a href="settings.php" class="sidebar-btn"><span class="sidebar-icon"><img src="../images/setting.png" alt="Settings"></span><span>Settings</span></a>
      </nav>
