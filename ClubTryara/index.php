    ...
    <aside class="sidebar" role="complementary" aria-label="Sidebar">
        ...
        <nav class="sidebar-menu" role="navigation" aria-label="Main menu">
            <a href="php/home.php" class="sidebar-btn active" aria-current="page">
                <span class="sidebar-icon"><img src="images/home.png" alt="Home icon"></span>
                <span>Home</span>
            </a>
            <a href="php/tables.php" class="sidebar-btn">
                <span class="sidebar-icon"><img src="images/table.png" alt="Tables icon"></span>
                <span>Tables</span>
            </a>
            <a href="php/inventory.php" class="sidebar-btn">
                <span class="sidebar-icon"><img src="images/inventory.png" alt="Inventory icon"></span>
                <span>Inventory</span>
            </a>
            <a href="php/sales_report.php" class="sidebar-btn">
                <span class="sidebar-icon"><img src="images/sales.png" alt="Sales report icon"></span>
                <span>Sales Report</span>
            </a>
            <a href="../clubtryara/settings/settings.php" class="sidebar-btn">
                <span class="sidebar-icon"><img src="images/setting.png" alt="Settings icon"></span>
                <span>Settings</span>
            </a>
        </nav>
    ...
    <main class="main-content" role="main" aria-label="Main content">
        ...
        <div class="topbar">
            ...
            <button class="select-table-btn" type="button" aria-haspopup="dialog">
                Select Table <span class="table-icon"><img src="images/table.png" alt="Table icon"></span>
            </button>
        </div>
        ...
        <div class="content-area">
            ...
            <aside class="order-section" aria-label="Order">
                <div class="order-actions">
                    ...
                    <button class="order-action-btn draft" id="draftBtn" type="button" title="Save draft"><img src="images/draft.png" alt="Draft"></button>
                    <button class="order-action-btn refresh" id="refreshBtn" type="button" title="Reset order"><img src="images/reset.png" alt="Reset"></button>
                </div>
